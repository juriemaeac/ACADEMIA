...
import 'package:sample1/Reminder/time.dart';
      ...
      body: ListView(
        children: <Widget>[
          Padding(
            ...
            child: Center(
              child: Text('Save feature is available for Premium users. But you can try it for free!',
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(
              primary: Color(0xFFE28C7E), // header background color
              onPrimary: Colors.black, // header text color
              onSurface: Colors.black, // body text color
            ),
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                primary: Color(0xFF98BD91), // button text color
              ),
            ),
          ),
          child: child,
...
List<Item> generateItems(List reminders) {
  return List.generate(reminders.length, (int index) {
    return Item(
      ...
      expandedValue:
          '${reminders[index][0].day} ${ReminderScreenState().monthsInYear[reminders[index][0].month]} ${reminders[index][0].year} , ${reminders[index][1].hourOfPeriod}:${ReminderScreenState().getminute(reminders[index][1])} ${ReminderScreenState().getm(reminders[index][1])}',
    );
  });
}
