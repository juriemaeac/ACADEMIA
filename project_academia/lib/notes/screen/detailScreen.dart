...
class NoteDetailState extends State<NoteDetail> {
  ...
  Widget build(BuildContext context) {
    titleController.text = note.titleNote;
    descriptionController.text = note.descriptionNote;
        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            child: Column(
              children: <Widget>[
                PriorityPicker(
                  selectedIndex: 3 - note.priorityNote,
                  onTap: (index) {
                    isEdited = true;
  ...
  void _delete() async {
    await helper.deleteNote(note.idNote);
    moveToLastScreen();
  }
}
